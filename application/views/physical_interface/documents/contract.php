	...
	<div class="container-fluid" style="position: relative;">
		<div class="row">
			<div class="span12">
      			...
      			<p>
					1.1. Исполнитель осуществляет, а Заказчик (далее - Слушатель)  проходит обучение по программам повышения квалификации. <br />
					1.2. Наименования программ повышения квалификации, количество часов, сроки обучения,перечень Слушателей указываются 
					Заказчиком в электронной заявке (далее – Заявка),оформляемой Заказчиком на Образовательном портале 
					АНО ДПО «Южно-окружной центр повышения квалификации» по адресу <a href="http://roscentrdpo.ru/">http://roscentrdpo.ru/</a> 
					(далее - Портал), на основании которой Заказчику выставляются Договор и Счёт.
				</p>
				<p>
				...
				<p>
					2.1. Предоставляемые Исполнителем услуги не облагаются НДС согласно статьи 149п. 2 главы 21 Налогового кодекса Российской Федерации.<br/>
