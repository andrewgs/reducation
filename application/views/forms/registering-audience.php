			...
			<fieldset>
				<div class="span9">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="lastname" class="span4 input-popover inpval" data-content="Введите Фамилию слушателя.<br/><strong>Например:</strong> Иванов" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="lastname" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="name" class="span4 input-popover inpval" data-content="Введите Имя слушателя.<br/><strong>Например:</strong> Иван" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="name" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="middlename" class="span4 input-popover inpval" data-content="Введите Отчество слушателя.<br/><strong>Например:</strong> Иванович" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="middlename" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="fiodat" class="span4 input-popover inpval" data-content="Введите Фамилию, Имя и Отчество слушателя в дательном падеже.<br/><strong>Например:</strong> Иванову Ивану Ивановичу" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="fiodat" value=""> <span class="badge badge-info">!</span>
							<span class="help-inline" style="display:none;">&nbsp;</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="position" class="span4 input-popover inpval" data-content="Введите должность слушателя.<br/><strong>Например:</strong> инженер" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="position" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea rows="3" id="address" class="span4 input-popover inpval" data-content="Введите почтовый адрес слушателя.<br/><strong>Например:</strong> Например: 344001, г.Ростов-на-Дону, ул.Республиканская, д.86" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="address"></textarea> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="personaphone" class="span4 input-popover inpval" data-content="Введите контактный номер телефона слушателя.<br/><strong>Например:</strong> (863)273-66-61" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="personaphone" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea rows="2" id="graduated" class="span4 input-popover inpval" data-content="Введите наименование учебного заведения где обучался слушатель" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="graduated"></textarea> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="typedocument" class="span2 input-popover" data-content="Выберите название документа об образовании слушателя" data-trigger="hover" data-placement="bottom" data-toggle="popover" data-original-title="Выберите из списка" name="typedocument">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="documentnumber" class="span4 input-popover inpval" data-content="Введите номер документа об образвании слушателя.<br/><strong>Например:</strong> ВСА 1234567" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="documentnumber" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="specialty" class="span4 input-popover inpval" data-content="Введите специальность слушателя.<br/><strong>Например:</strong> Компьютерные системы и сети" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="specialty" value=""> <span class="badge badge-info">!</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="qualification" class="span4 input-popover inpval" data-content="Введите квалификацию слушателя.<br/><strong>Например:</strong> Инженер компьютерных систем и сетей" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="qualification" value=""> <span class="badge badge-info">!</span>
