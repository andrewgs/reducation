					...
					<div>
						...
						<?php for($j=0,$num=1;$j<count($answers);$j++):?>
							<?php if($answers[$j]['testquestion'] == $questions[$i]['id']):?>
								<tr>
									<td><a href="#editAnswer" title="Редактировать" class="editAnswer" data-toggle="modal"><i class="icon-pencil"></i></a></td>
									<td><?=$num;?></td>
									<td><span><?=$answers[$j]['title'];?></span></td>
								<?php if($answers[$j]['correct']):?>
									<td><i class="icon-ok-sign" title="Верный ответ" idanswer="<?=$answers[$j]['id'];?>" val="1"></i></td>
								<?php else:?>
									<td><i class="icon-remove-sign" title="Не верный ответ" idanswer="<?=$answers[$j]['id'];?>" val="0"></i></td>
								<?php endif;?>
									<td><a class="close" data-toggle="modal" href="#deleteAnswer">&times;</a></td>
								</tr>
								<?php $num++;?>
							<?php else:?>
								<?php continue; ?>
