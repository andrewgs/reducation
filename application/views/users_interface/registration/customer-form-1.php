		...
		<div class="span6" style="margin-left:0px;">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" id="accountkornumber" class="span3 input-popover inpval digital" data-content="Введите номер корреспондентского счета Вашей организации" data-trigger="focus" data-placement="bottom" data-toggle="popover" data-original-title="Обязательное поле" name="accountkornumber" maxlength="20" value="<?=$this->session->userdata('accountkornumber')?>"> <span class="badge badge-info">!</span>
						<span class="help-inline" style="display:none;">&nbsp;</span>
					</div>
				</div>
				<div class="control-group">
