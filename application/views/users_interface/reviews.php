		...
		<div class="row">
			<div class="span12">
				...
				<ul class="otzv clearfix">
					...
					<li>
						<a href="<?=base_url();?>img/otzv_14.jpg" target="blank_">
							<img src="<?=base_url();?>img/otzv_14.jpg" alt="Отзыв" />
						</a>
					</li>
					<li>
						<a href="<?=base_url();?>img/otzv_15.jpg" target="blank_">
							<img src="<?=base_url();?>img/otzv_15.jpg" alt="Отзыв" />
						</a>
					</li>
					<li>
						<a href="<?=base_url();?>img/otzv_16.jpg" target="blank_">
							<img src="<?=base_url();?>img/otzv_16.jpg" alt="Отзыв" />
						</a>
					</li>
					<li>
						<a href="<?=base_url();?>img/otzv_17.jpg" target="blank_">
							<img src="<?=base_url();?>img/otzv_17.jpg" alt="Отзыв" />
						</a>
					</li>
					<li>
