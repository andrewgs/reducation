	...
	<div class="container">
		<div class="row">
			<div id="promo-banner" class="span12">
				...
				<h3>Повышение квалификации через интернет с выдачей удостоверения государственного образца.</h3>
			</div>
		</div>
		<div class="row">
			<div class="span9">
				...
				<p>
					...
					тестирования слушатели курсов получают удостоверения государственного образца.
				</p>
			</div>
			<div class="span3">
		...
		<div class="row">
			...
			<div class="span3">
				...
				<p>
					Как только слушатели успешно завершают обучение, мы выдаем государственные удостоверения о 
