		...
		<div class="row">
			<div class="span12">
				...
				<p class="intend">
			      ...
			      действующей на основании доверенности (№1 от <?=(strtotime($order['date']) < 1365537600)?'10.04.2012':'10.04.'.date("Y");?> г.), с одной стороны, и 
				...
				<p>
					1. Стоимость оказанных услуг составляет <?=$summ;?> руб. <br />
